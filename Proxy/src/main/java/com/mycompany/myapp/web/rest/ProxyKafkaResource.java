...
@RestController
@RequestMapping("/api/proxy-kafka")
public class ProxyKafkaResource {

    private static final String PRODUCER_BINDING_NAME = "binding-out-0";

    private static final Logger LOG = LoggerFactory.getLogger(ProxyKafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public ProxyKafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
